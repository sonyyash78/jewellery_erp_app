    ...
    <ScrollView style={styles.container}>
      <View style={styles.summaryCard}>
        ...
        <View style={styles.row}>
          ...
          <Text style={styles.value}>,1 {total_old_value.toFixed(2)}</Text>
        </View>
        <View style={styles.row}>
          <Text style={styles.label}>Total New Value (To Customer):</Text>
          <Text style={styles.value}>,1 {total_new_value.toFixed(2)}</Text>
        </View>
        <View style={styles.row}>
          <Text style={styles.label}>GST on New Items (3%):</Text>
          <Text style={styles.value}>,1 {gstAmount.toFixed(2)}</Text>
        </View>
        <View style={[styles.row, styles.grandTotalRow]}>
          <Text style={styles.grandTotalLabel}>Grand Total (New):</Text>
          <Text style={styles.grandTotalValue}>,1 {grand_total.toFixed(2)}</Text>
        </View>
        ...
        <View style={[styles.row, {marginTop: 24}]}>
          ...
          <Text style={[styles.diffValue, { color: difference_amount > 0 ? '#ef4444' : '#4ade80' }]}>
            ...
            ,1 {Math.abs(difference_amount).toFixed(2)}
          </Text>
        </View>
      </View>
